          ...
          >
            ...
            <div className="part1">
              ...
              <input
                ...
                onChange={(e) => {
                  setNewUser({ ...newUser, schoolid: e.currentTarget.value });
                }}
              />
              ...
              <input
                ...
                onChange={(e) => {
                  setNewUser({ ...newUser, cin: e.currentTarget.value });
                }}
              />
            ...
            <div className="part2">
              ...
              <input
                ...
                onChange={(e) => {
                  setNewUser({ ...newUser, address: e.currentTarget.value });
                }}
              />
              ...
              <input
                ...
                onChange={(e) => {
                  setNewUser({ ...newUser, dob: e.currentTarget.value });
                }}
              />
            ...
            <button onClick={() =>{
              Signup()
            }} className="btn-signup" type="submit">
              Add User
            </button>
          </form>
        </div>
